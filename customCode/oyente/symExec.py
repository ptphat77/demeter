...
def detect_time_dependency():
    ...
    if time_dependency.is_vulnerable():
        print('Timestamp Dependency;')
...
def detect_money_concurrency():
    ...
    if money_concurrency.is_vulnerable():
        print('Transaction-Ordering Dependence (TOD);')
...
def detect_callstack_attack():
    ...
    if callstack.is_vulnerable():
    	print('Callstack Depth Attack Vulnerability;')
...
def detect_reentrancy():
    ...
    if reentrancy.is_vulnerable():
        print("Re-Entrancy Vulnerability;")
